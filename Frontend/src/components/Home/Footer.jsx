...
<div data-v-c4b9aaee="" className="tabbar__container" >
            ...
            <Link to="/promotion">
                <div data-v-c4b9aaee="" className="tabbar__container-item" >
                    <svg data-v-c4b9aaee=""
                        xmlns="http://www.w3.org/2000/svg" width="57" height="49" fill="none" viewBox="0 0 57 49" className="" style={{zIndex: "3", width: "2rem", height: "2rem", position: "absolute", top: "-5px"}}>
