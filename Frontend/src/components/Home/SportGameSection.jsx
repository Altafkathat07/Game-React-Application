...
import img1 from "../../assets/images/vendorlogo_20240102161956p963.png"
import img2 from "../../assets/images/vendorlogo_20231026192502ebp9.png"

function SportGameSection() {
  return (
    <>
      <div data-v-a900648a="" className="orignal">
                            <div data-v-a900648a1="" className="daman-title daman-line">
                                <div data-v-a900648a1="" className="daman-title-left"><span data-v-a900648a1="">Sports</span></div>
                                <div data-v-a900648a1="" className="btn-all">
                                    <span data-v-a900648a1="">All</span><span data-v-a900648a1="">2</span><svg
                            ...
                            <div data-v-03087118="" data-v-a900648a="" className="daman__container allGame">
                                <div data-v-03087118="" className="item"><img data-v-03087118="" className="gameImg"
                                    ...
                                    />
                                    <div data-v-03087118="" className="game-type">Sports</div>
                                </div>
                                <div data-v-03087118="" className="item"><img data-v-03087118="" className="gameImg"
...
export default SportGameSection
