...
function RiskContent() {
  return (
    <>
      <div data-v-21f35055="" className="content">
                    <h3 className="text-xs-center" >
                        <p className="MsoNormal">
                            <span>
                                </span></p><div className="col-12 justify">
                                    ...
                                    <p>The following definitions shall have the same meaning regardless of whether they
                                        appear in singular or inplural.</p>
                                    <h3>Definitions</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p><strong>Company</strong> (referred to as either the Company, We, Us
                                                or Our in this Agreement) refers to<text className="tfw-6 text-blue">
                                                    viplottery</text>.</p>
                                        </li>
                                        ...
                                        <li><strong>Website</strong> refers to<text className="tfw-6 text-blue">
                                                viplottery</text>, accessible from<text className="text-blue">
                                                http://viplottery.club/</text></li>
                                    ...
                                    <p>Usage Data may include information such as Your Devices Internet Protocol
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <p>Type: Persistent Cookies</p>
                                            <p>Administered by: Us</p>
                                            <p>Purpose: These Cookies allow us to remember choices You make when You use
                                    ...
                                    <p>For more information about the cookies we use and your choices regarding cookies,
                                        please visit our Cookies Policy.</p>
                                    <h3>Use of Your Personal Data</h3>
                                    <p>The Company may use Personal Data for the following purposes:</p>
                                    <ul>
                                        <li><strong>To provide and maintain our Service</strong>, including to monitor
                                            the usage of our Service.</li>
                                        <li><strong>To manage Your Account:</strong> to manage Your registration as a
                                        ...
                                        <li><strong>For the performance of a contract:</strong> the development,
                                            ...
                                            Service.</li>
                                        <li><strong>To contact You:</strong> To contact You by email, telephone calls,
                                        ...
                                        <li><strong>To manage Your requests:</strong> To attend and manage Your requests
                                            to Us.</li>
                                    </ul>
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>With Business partners:</strong> We may share Your information with
                                    ...
                                    <p>Your information, including Personal Data, is processed at the Companys
                                    ...
                                    <p>If We need to rely on consent as a legal basis for processing Your information
                                        and Your country requires consent from a parent, We may require Your parents
                                        consent before We collect and use that information.</p>
                                    <h2>Links to Other Websites</h2>
                                    <p>Our Service may contain links to other websites that are not operated by Us. If
                                        You click on a third party link, You will be directed to that third partys
